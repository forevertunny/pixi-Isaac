...
function TextInput (options)
{
    ...
    if (typeof this._pui_tempInput === "undefined")
    {
        this._pui_tempInput = document.createElement("INPUT");
        this._pui_tempInput.setAttribute("type", "text");
        this._pui_tempInput.setAttribute("id", "_pui_tempInput");
        this._pui_tempInput.setAttribute("style", "position:fixed; left:-10px; top:-10px; width:0px; height: 0px;");
        document.body.appendChild(this._pui_tempInput);
    }
    ...
    {
        var c = this._pui_tempInput.value;
        if (c.length)
        {
            insertTextAtCaret(c);
            this._pui_tempInput.value = "";
        }
        e.preventDefault();
    };
    ...
    this.focus = function ()
    {
        if (!this._focused)
        {
            ...
            this._pui_tempInput.setAttribute("style", "position:fixed; left:" + l + "; top:" + t + "; height:" + h + "; width:" + w + ";");
            this._pui_tempInput.value = "";
            this._pui_tempInput.focus();
            this._pui_tempInput.setAttribute("style", "position:fixed; left:-10px; top:-10px; width:0px; height: 0px;");

            innerContainer.cacheAsBitmap = false;
            this._pui_tempInput.addEventListener("blur", inputBlurEvent, false);
            ...
            this._pui_tempInput.addEventListener('input', inputEvent, false);
    ...
    this.blur = function ()
    {
        if (this._focused)
        {
            ...
            this._pui_tempInput.removeEventListener("blur", inputBlurEvent);
            ...
            this._pui_tempInput.removeEventListener('input', inputEvent);
            this._pui_tempInput.blur();
