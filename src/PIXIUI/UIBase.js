...
Object.defineProperties(UIBase.prototype, {
    ...
    percen_width: {
        get: function ()
        {
            if ((this.setting.width.toString()).indexOf('%') !== -1)
            {
                return this.setting.width;
            }
            else
            {
                return (this.setting.width / this.parent._width * 100) + "%";
            }
        }
    },
    height: {
    ...
    left: {
        ...
        set: function (val)
        {
            if (isNaN(val) && val.indexOf('%') !== -1)
            {
                ...
                {
                    tempPct += parseFloat(sp[i]);
                }

                this.setting.leftPct = tempPct * 0.01;//parseFloat(val.replace('%', '')) * 0.01;
            }
            else
        ...
        get: function ()
        {
            if (this.dirty)
            {
                if (this.setting.leftPct !== null)
                {
                    ...
                    // if (this.name === "AA")
                    // {
                    //     console.log(this.parent._width);
                    //     console.log(this.setting.leftPct);
    ...
    right: {
        ...
        set: function (val)
        {
            if (isNaN(val) && val.indexOf('%') !== -1)
            {
                ...
                this.setting.rightPct = tempPct * 0.01;//parseFloat(val.replace('%', '')) * 0.01;
            }
            else
    ...
    top: {
        ...
        set: function (val)
        {
            if (isNaN(val) && val.indexOf('%') !== -1)
            {
                ...
                this.setting.topPct = tempPct * 0.01;//parseFloat(val.replace('%', '')) * 0.01;
            }
    ...
    bottom: {
        ...
        set: function (val)
        {
            if (isNaN(val) && val.indexOf('%') !== -1)
            {
                ...
                this.setting.bottomPct = tempPct * 0.01 //parseFloat(val.replace('%', '')) * 0.01;
            }
